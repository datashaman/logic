...
Object
	...
	.forEach(function (entry) {
		allFunctions[entry[0]] = new FuzzySearch(entry[1], ['shortName', 'summary'])
	})
...
const store = new Vuex.Store({
    ...
    getters: {
		files: state => {
			return Object.keys(state.allFunctions)
		},
        functions: state => {
        	let results = {}

        	Object
        		.entries(state.allFunctions)
				.forEach(function (entry) {
					results[entry[0]] = entry[1].search(state.query)
				})
